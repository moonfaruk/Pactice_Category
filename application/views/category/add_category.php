...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row">
                <form class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/categories/save" method="post">
                    <div class="col-md-offset-3 col-md-6 col-md-offset-3" style="height: 350px;background-color: #ebebeb;">
                        <div class="row">
                            <h3 align="center">Add Category Form</h3><hr>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-6 col-md-4">
                                <input type="submit" name="btn" class="btn btn-primary" value="Save Category" />
                            </div>
                        </div>
                        <div class="form-group">
